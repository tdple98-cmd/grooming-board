...
export function rowToBoardDog(appt, visit, photoUrls = {}, thumbUrls = {}, photoHistory = []) {
  const dog = appt.dogs || {};
  ...
  const prevPhotoPath = history.find((h) => h.path !== groomPhotoPath)?.path || null;
  ...
  if (visit) {
    ...
    lastVisit = {
      ...
      photoThumbUrl: visitPhotoPath ? thumbUrls[visitPhotoPath] || photoUrls[visitPhotoPath] || null : null,
    };
  }
  ...
  return {
    ...
    groomPhotoThumbUrl: groomPhotoPath
      ? thumbUrls[groomPhotoPath] || photoUrls[groomPhotoPath] || null
      : null,
    photoHistory: history,
    prevPhotoPath,
    prevPhotoUrl: prevPhotoPath ? photoUrls[prevPhotoPath] || null : null,
    prevPhotoThumbUrl: prevPhotoPath
      ? thumbUrls[prevPhotoPath] || photoUrls[prevPhotoPath] || null
      : null,
